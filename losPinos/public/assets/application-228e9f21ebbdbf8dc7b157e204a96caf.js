...
(function() {
  window.App = angular.module('LosPinos', ['ngResource']);
...
(function() {
  App.controller('ClienteController', [
    '$scope', 'filterFilter', '$http', function($scope, $filterFilter, $http) {
      $scope.clientes = [];
      return $http.get('./clientes.json').success(function(data) {
        return $scope.clientes = data;
      });
    }
  ]);
...
(function() {
  App.controller('ControlHabitacionesController', [
    '$scope', 'filterFilter', '$http', function($scope, $filterFilter, $http) {
      $scope.habitaciones = [];
      return $http.get('./habitacions.json').success(function(data) {
        return $scope.habitaciones = data;
      });
    }
  ]);
...
(function() {
  App.controller('HomeCtrl', [
    '$scope', '$location', '$http', '$timeout', function($scope, $location, $http, $timeout) {
      var fireDigestEveryMinute;
      $scope.reservas = [];
      $http.get('./ultimas_reservas.json').success(function(data) {
        return $scope.reservas = data;
      });
      $scope.difference = function(reserva) {
        var dias, horas, min, tiempo;
      ...
      $scope.set_color = function(reserva) {
      ...
      fireDigestEveryMinute = function() {
        $timeout((function() {
          fireDigestEveryMinute();
        }), 60000);
      };
      return fireDigestEveryMinute();
    }
  ]);

}).call(this);
(function() {
  App.controller('ReservaController', [
    '$scope', 'filterFilter', '$http', function($scope, $filterFilter, $http) {
      $scope.reservas = [];
      return $http.get('./reservas_display.json').success(function(data) {
        return $scope.reservas = data;
      });
    }
  ]);
